  ...
  return (
    ...
    >
      <div style={{
        ...
        <div style={{ width: 36, height: 36, borderRadius: 'var(--r-lg)', background: 'rgba(255,68,68,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 14, color: '#ff5555' }}>
          <AlertTriangleIcon />
        </div>
        ...
        {modal.warning && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#ffaa55', background: 'rgba(255,170,85,0.07)', border: '1px solid rgba(255,170,85,0.2)', borderRadius: 'var(--r-md)', padding: '8px 12px', marginBottom: 18, fontFamily: 'Geist Mono, monospace' }}>
        ...
        {needsTyping && (
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              autoFocus
              style={{ width: '100%', background: 'var(--base)', border: '1px solid var(--border)', borderRadius: 'var(--r-md)', padding: '8px 12px', fontSize: 13, color: 'var(--text)', fontFamily: 'Geist Mono, monospace', outline: 'none', transition: 'border-color var(--transition-fast)' }}
        ...
        {error && (
          <div style={{ fontSize: 11, color: '#ff5555', background: 'rgba(255,68,68,0.07)', border: '1px solid rgba(255,68,68,0.2)', borderRadius: 'var(--r-md)', padding: '8px 12px', marginBottom: 14, fontFamily: 'Geist Mono, monospace' }}>
            {error}
          </div>
        )}
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end' }}>
          <button onClick={onCancel} disabled={loading}
            style={{ padding: '8px 16px', borderRadius: 'var(--r-md)', border: '1px solid var(--border)', background: 'transparent', color: 'var(--dim)', fontSize: 12, fontFamily: 'Geist, sans-serif', cursor: loading ? 'default' : 'pointer' }}>
            Cancel
          </button>
          <button onClick={onConfirm} disabled={!canConfirm || loading}
            style={{
              ...
              cursor: canConfirm && !loading ? 'pointer' : 'not-allowed', transition: 'background var(--transition-fast)',
            }}>
