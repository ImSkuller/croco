...
pub fn templates_list() -> Vec<Value> {
    vec![
        json!({ "id": "empty",          "name": "Empty",              "desc": "A blank project with no files.",                           "icon": "folder",   "color": "#8a8a8a", "category": "Blank",     "tags": [],                                    "hasInstall": false }),
        json!({ "id": "vanilla-js",     "name": "Vanilla JS",         "desc": "Plain HTML, CSS, and JavaScript. No build tools.",         "icon": "window",   "color": "#f0db4f", "category": "Frontend",  "tags": ["html","css","javascript"],           "hasInstall": false }),
        json!({ "id": "react-vite",     "name": "React + Vite",       "desc": "React 18 with Vite for blazing-fast HMR.",                 "icon": "window",   "color": "#61dafb", "category": "Frontend",  "tags": ["react","vite","javascript"],         "hasInstall": true }),
        json!({ "id": "react-ts",       "name": "React + TypeScript", "desc": "React 18 with TypeScript and Vite.",                       "icon": "window",   "color": "#3178c6", "category": "Frontend",  "tags": ["react","typescript","vite"],         "hasInstall": true }),
        json!({ "id": "react-tailwind", "name": "React + Tailwind",   "desc": "React + Vite with Tailwind CSS.",                          "icon": "window",   "color": "#38bdf8", "category": "Frontend",  "tags": ["react","vite","tailwind"],           "hasInstall": true }),
        json!({ "id": "vue-vite",       "name": "Vue 3 + Vite",       "desc": "Vue 3 with the Composition API and Vite.",                 "icon": "window",   "color": "#42b883", "category": "Frontend",  "tags": ["vue","vite","javascript"],           "hasInstall": true }),
        json!({ "id": "svelte-vite",    "name": "Svelte + Vite",      "desc": "Svelte with Vite for fast development.",                   "icon": "window",   "color": "#ff3e00", "category": "Frontend",  "tags": ["svelte","vite","javascript"],        "hasInstall": true }),
        json!({ "id": "astro",          "name": "Astro",              "desc": "Content-driven site builder. Zero JS by default.",         "icon": "window",   "color": "#ff5d01", "category": "Frontend",  "tags": ["astro","static","javascript"],       "hasInstall": true }),
        json!({ "id": "nextjs",         "name": "Next.js",            "desc": "Next.js 14 with App Router (React + TypeScript).",         "icon": "window",   "color": "#eaeaea", "category": "Fullstack", "tags": ["react","nextjs","typescript"],       "hasInstall": true }),
        json!({ "id": "sveltekit",      "name": "SvelteKit",          "desc": "Full-stack framework powered by Svelte.",                  "icon": "window",   "color": "#ff3e00", "category": "Fullstack", "tags": ["svelte","sveltekit","fullstack"],    "hasInstall": true }),
        json!({ "id": "nuxt",           "name": "Nuxt 3",             "desc": "Vue-based fullstack framework.",                           "icon": "window",   "color": "#00dc82", "category": "Fullstack", "tags": ["vue","nuxt","fullstack"],            "hasInstall": true }),
        json!({ "id": "express-api",    "name": "Express API",        "desc": "RESTful API server with Express.js.",                      "icon": "database",  "color": "#a3a3a3", "category": "Backend",   "tags": ["nodejs","express","api"],            "hasInstall": true }),
        json!({ "id": "fastify-api",    "name": "Fastify API",        "desc": "High-performance API server with Fastify.",                "icon": "database",  "color": "#ffd700", "category": "Backend",   "tags": ["nodejs","fastify","api"],            "hasInstall": true }),
        json!({ "id": "hono-api",       "name": "Hono API",           "desc": "Ultra-fast web framework for edge and Node.js.",          "icon": "database",  "color": "#ff6b35", "category": "Backend",   "tags": ["nodejs","hono","api","edge"],        "hasInstall": true }),
        json!({ "id": "python-flask",   "name": "Python Flask",       "desc": "Lightweight Python web framework.",                        "icon": "database",  "color": "#4b8bbe", "category": "Backend",   "tags": ["python","flask","api"],              "hasInstall": false }),
        json!({ "id": "python-fastapi", "name": "Python FastAPI",     "desc": "Modern async Python API with auto-generated docs.",        "icon": "database",  "color": "#05998b", "category": "Backend",   "tags": ["python","fastapi","async","api"],    "hasInstall": false }),
        json!({ "id": "node-cli",       "name": "Node.js CLI",        "desc": "Command-line tool with Commander.js and Chalk.",           "icon": "terminal", "color": "#68a063", "category": "CLI",       "tags": ["nodejs","cli","commander"],          "hasInstall": true }),
        json!({ "id": "electron-react", "name": "Electron + React",   "desc": "Desktop app with Electron and React + Vite.",             "icon": "window",   "color": "#9feaf9", "category": "Desktop",   "tags": ["electron","react","desktop","vite"], "hasInstall": true }),
        json!({ "id": "go-http",        "name": "Go HTTP Server",     "desc": "HTTP server in Go using the standard library.",            "icon": "database",  "color": "#00add8", "category": "Other",     "tags": ["go","golang","http"],                "hasInstall": false }),
        json!({ "id": "rust-cli",       "name": "Rust CLI",           "desc": "Command-line tool in Rust with Cargo.",                   "icon": "terminal", "color": "#dea584", "category": "Other",     "tags": ["rust","cli","cargo"],                "hasInstall": false }),
        json!({ "id": "monorepo",       "name": "Turborepo",          "desc": "Monorepo with Turborepo, apps/web (Next.js) and packages/ui.", "icon": "package", "color": "#eb1c24", "category": "Other", "tags": ["monorepo","turborepo","nextjs"],     "hasInstall": true }),
        json!({ "id": "mc-paper",      "name": "Paper Plugin",       "desc": "Minecraft Paper/Spigot server plugin with Maven.",             "icon": "game", "color": "#e0dcc8", "category": "Minecraft", "tags": ["java","minecraft","paper","spigot","maven"],  "hasInstall": true }),
        json!({ "id": "mc-fabric",     "name": "Fabric Mod",         "desc": "Minecraft Fabric mod with Gradle and Java.",                  "icon": "game", "color": "#dbb69b", "category": "Minecraft", "tags": ["java","minecraft","fabric","gradle","mod"],   "hasInstall": true }),
        json!({ "id": "mc-forge",      "name": "Forge Mod",          "desc": "Minecraft NeoForge mod with Gradle and Java.",                "icon": "game", "color": "#f16436", "category": "Minecraft", "tags": ["java","minecraft","forge","neoforge","gradle"],"hasInstall": true }),
        json!({ "id": "mc-velocity",   "name": "Velocity Plugin",    "desc": "Velocity proxy plugin with Maven (Java).",                    "icon": "game", "color": "#0072ce", "category": "Minecraft", "tags": ["java","minecraft","velocity","proxy","maven"], "hasInstall": true }),
        json!({ "id": "mc-bungeecord", "name": "BungeeCord Plugin",  "desc": "BungeeCord proxy plugin with Maven (Java).",                  "icon": "game", "color": "#f7b731", "category": "Minecraft", "tags": ["java","minecraft","bungeecord","waterfall","maven"], "hasInstall": true }),
    ]
}
